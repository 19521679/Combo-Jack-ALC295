...
#define codecIDArr_len 5
long codecIDArr[codecIDArr_len] = {0x10ec0257, 0x10ec0256, 0x10ec0255, 0x10ec0295, 0x10ec0298};
...
static uint32_t unplugged()
{
    ...
    switch (codecID)
    {
        ...
        ALC255_256: //common commands for alc255/256
            ...
            break;
        case 0x10ec0295:
            VerbCommand(HDA_VERB(0x19, AC_VERB_SET_PIN_WIDGET_CONTROL, 0x00));
            break;
        case 0x10ec0298:
